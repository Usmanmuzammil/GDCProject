...
<style>
    /* Ensure the sidebar (Visitors dropdown) works correctly on mobile */
@media (max-width: 991px) {
    /* Make the sidebar always visible on mobile, no need to collapse */
    #navbar-vertical {
        display: !important;
        width: 100%;
    }
    
    /* Adjust the dropdown for better mobile visibility */
    .navbar-vertical .navbar-nav {
        display:;
    }

    /* Optional: you can add custom styles for the dropdown toggle on mobile */
    .navbar-vertical a.nav-item {
        padding: 10px 20px;
    }
}
        ...
        <div class="row border-top px-xl-5">
            ...
            <div class="col-lg-3">
                <a class="d-flex align-items-center justify-content-between bg-secondary w-100 text-decoration-none" data-toggle="collapse" href="#navbar-vertical" style="height: 67px; padding: 0 30px;">
                    <h5 class="text-primary m-0"><i class="fa fa-book-open mr-2"></i>Visitor Site</h5>
                    <i class="fa fa-angle-down text-primary"></i>
                </a>
                <nav class="collapse navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0 bg-light" id="navbar-vertical" style="z-index: 9;">
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav py-0">
                            ...
                            <a href="{{url('courses')}}" class="nav-item nav-link {{ Request::is('courses') ? 'active' : '' }}">Books</a>
                            <a href="{{url('attendence')}}" class="nav-item nav-link {{ Request::is('attendence') ? 'active' : '' }}">Attendence</a>
                            <a href="{{url('teachers')}}" class="nav-item nav-link {{ Request::is('teachers') ? 'active' : '' }}">Faculty</a>
                            
                            <!-- Dropdown for Events -->
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Event</a>
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="{{url('event')}}" class="dropdown-item {{ Request::is('event') ? 'active' : '' }}">Event List</a>
                                </div>
                            </div>
                        </div>
                        
                        <!-- Connect Now Button (Visible only on Desktop) -->
